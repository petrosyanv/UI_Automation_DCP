...
class TestValidateButton:
    ...
    def test_valid_button(self):
        ...
        assert 'Site map' != self.client.home_page.get_value_information_button_site_map()
        ...
        assert 'My personal info' != self.client.home_page.get_value_my_account_button_my_personal_info()
